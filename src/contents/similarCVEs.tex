...
\begin{description}
    \item[CVE-2021-45046]\footfullcite{45046}\hfill \\Eine weitere Log4Shell Sicherheitslücke, die im offiziellen Patch für CVE-2021-4428\footfullcite{44228} übersehen wurde, und wenn nicht-standard Konfigurationen verwendet werden weiterhin \gls{rce} erlaubt.
    ...
    \item[CVE-2021-45105]\footfullcite{45105}\hfill \\Ein weiterer Teil der Log4Shell Sicherheitslücke, die durch einen StackOverflow ausgelöste \gls{dos} Attacken ermöglichen.
\end{description}
