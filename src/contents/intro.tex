...
Betroffen hierbei war die oft eingesetzte Bibliothek Log4j (Version 2).\footfullcite{lunasec}
...
Zudem werden in dieser Arbeit einige Technologien, wie beispielsweise die tatsächliche Implementierung des Loggers oder Serialisierung der Objekte in der \gls{jvm}, grob umrissen um im Rahmen der Studienarbeit zu bleiben.\footfullcite{sophos}
